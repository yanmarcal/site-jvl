...
export default function StatsBar() {
  ...
  return (
    <section className="bg-emerald-950/40 border-b border-emerald-900/30 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="flex flex-col items-center text-center p-4 rounded-xl bg-slate-900/70 border border-emerald-900/40"
              >
                <div className="w-10 h-10 rounded-lg bg-emerald-900/50 flex items-center justify-center text-emerald-400 mb-2 border border-emerald-500/20">
