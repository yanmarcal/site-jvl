    ...
    <section id="inicio" className="relative overflow-hidden border-b border-slate-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-36">
        <div className="max-w-2xl flex flex-col gap-5">
          <div className="inline-flex items-center gap-2 self-start bg-lime-950/80 backdrop-blur-sm border border-lime-400/40 text-lime-400 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider">
            <Award className="w-4 h-4 text-lime-400" />
            <span className="text-lime-400">Especialistas em Carretas Desde 2010 • Mais de 14 Anos</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-lg">
            ...
            <span className="text-lime-400">CARRETAS E CAMINHÕES</span> EM GUARULHOS - SP
          </h1>
...
<p className="text-lime-400 font-bold uppercase tracking-wider text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-lime-400 hover:bg-lime-400/90 text-slate-950 font-black text-base px-6 py-3.5 rounded-xl shadow-xl transition-all border border-lime-400/40"
            >
