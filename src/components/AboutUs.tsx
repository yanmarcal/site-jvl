        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight">
              Especialistas em Mecânica de Carretas <span className="text-lime-500">Desde 2010</span>
            </h2>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-lime-500/80 to-slate-900 border border-lime-500/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-950 p-6 rounded-2xl border border-slate-500 space-y-3 sm:col-span-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-lime-500 text-white flex items-center justify-center shrink-0">
