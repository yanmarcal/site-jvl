...
export default function AboutUs() {
  return (
    <section id="sobre" className="py-16 sm:py-20 bg-blue-900 border-b border-slate-500 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 bg-lime-950 border border-lime-500/30 text-lime-400 px-3.5 py-1 rounded-full text-xs font-bold uppercase">
              Nossa História
            </div>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-lime-950/80 to-slate-900 border border-lime-500/40">
              <div className="flex items-center gap-2 text-lime-400 font-bold uppercase text-sm tracking-wider">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-blue-900 p-6 rounded-2xl border border-slate-500 space-y-3">
                <div className="w-10 h-10 rounded-xl bg-lime-950 text-lime-400 flex items-center justify-center border border-lime-500/30">
              ...
              <div className="bg-blue-900 p-6 rounded-2xl border border-slate-500 space-y-3 sm:col-span-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-lime-600 text-white flex items-center justify-center shrink-0">
