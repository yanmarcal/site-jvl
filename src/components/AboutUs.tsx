...
export default function AboutUs() {
  return (
    <section id="sobre" className="py-16 sm:py-20 bg-slate-950 border-b border-slate-800 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 bg-emerald-950 border border-emerald-500/30 text-emerald-400 px-3.5 py-1 rounded-full text-xs font-bold uppercase">
              Nossa História
            </div>

            <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight">
              Especialistas em Mecânica de Carretas <span className="text-emerald-400">Desde 2010</span>
            </h2>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-950/80 to-slate-900 border border-emerald-500/40">
              <div className="flex items-center gap-2 text-emerald-400 font-bold uppercase text-sm tracking-wider">
          ...
          <div className="lg:col-span-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 space-y-3 sm:col-span-2">
                ...
                <p className="text-xs text-slate-300 leading-relaxed pt-1">
                  Facilidade de acesso no centro de São Paulo para carretas, caminhões e cavalos mecânicos com box de atendimento amplo e ágil.
                </p>
              </div>
