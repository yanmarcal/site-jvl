    ...
    <section id="inicio" className="relative overflow-hidden border-b border-slate-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-36">
        <div className="max-w-2xl flex flex-col gap-5">
          <div className="inline-flex items-center gap-2 self-start bg-emerald-950/80 backdrop-blur-sm border border-emerald-500/40 text-emerald-300 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider">
          ...
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-lg">
            ...
            <span className="text-emerald-400">CARRETAS</span> EM SÃO PAULO
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-black text-base px-6 py-3.5 rounded-xl shadow-xl transition-all border border-emerald-400/40"
            >
            ...
            <a
              href="#catalogo"
              className="inline-flex items-center justify-center gap-2 bg-slate-950/70 backdrop-blur-sm hover:bg-slate-900 text-slate-100 font-semibold text-base px-6 py-3.5 rounded-xl border border-slate-600 transition-all"
            >
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-300 pt-1">
            ...
            <a href="https://wa.me/5511988887555" target="_blank" rel="noopener noreferrer" className="text-emerald-400 font-bold hover:underline">(11) 98888-7555</a>
            <span className="text-slate-600">|</span>
            <a href="https://wa.me/5511992144678" target="_blank" rel="noopener noreferrer" className="text-emerald-400 font-bold hover:underline">(11) 99214-4678</a>
          </div>
        </div>
      </div>
    </section>
